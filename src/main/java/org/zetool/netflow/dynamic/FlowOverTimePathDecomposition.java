 ...
 * @author Martin Groß
 */
public class FlowOverTimePathDecomposition
        extends AbstractAlgorithm<ImplicitTimeExpandedResidualNetwork, PathBasedFlowOverTime> {

    /** The flow this algorithm works on. Only used internally during the computation. */
    private transient EdgeBasedFlowOverTime flow;
    /** Input for algorithm; only used internally during the computation. */
    ...
    /**
     * Computes a shortest super-source to sink path and stores the preceeding edges and arrival times in the supplied
     * data structures.
     *
    ...
    /**
     * Determines the bottleneck capacity of the specified path and subtracts flow from this path equal to the
     * bottleneck capacity.
     *
