...
class DefaultResidualGraph extends DefaultGraph implements ResidualGraph {
    ...
    /**
     * Returns the reverse edge of the specified edge. Runtime O(1). The reverse edge of an reverse edge is the original
     * edge again.
     *
    ...
    /**
     * Augments a specified amount of flow along the specified edge. The residual capacities of the edge and its reverse
     * edge are updated automatically. The residual graph is updated as well, if neccessary. Runtime O(1).
     *
