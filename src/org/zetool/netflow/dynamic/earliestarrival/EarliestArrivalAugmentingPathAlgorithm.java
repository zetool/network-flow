 ...
 * @author Martin Groß
 */
public class EarliestArrivalAugmentingPathAlgorithm extends
        AbstractAlgorithm<EarliestArrivalAugmentingPathProblem, EarliestArrivalAugmentingPath> {
     ...
     * @return an <code>EarliestArrivalAugmentingPath</code> according to Tjandra's definition or an empty path object,
